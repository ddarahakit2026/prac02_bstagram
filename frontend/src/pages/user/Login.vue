        ...
        <section id="auth" class="flex direction-column">
            <div class="panel login flex direction-column">
                ...
                <form @submit.prevent="onSubmit()">
                    <input name="email" v-model="loginForm.email" placeholder="핸드폰 번호나 이메일 입력" />
                    <input name="password" v-model="loginForm.password" type="password" placeholder="비밀번호" />
            ...
            <div class="panel register flex justify-content-center">
                <p>아직 회원이 아니신가요?</p>
                <RouterLink to="/user/signup">가입하기</RouterLink>
