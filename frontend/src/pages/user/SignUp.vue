...
<template>
        ...
        <section id="auth" class="flex direction-column">
            <div class="panel login flex direction-column">
                ...
                <form @submit.prevent="onSubmit()">
                    <input name="email" v-model="signupForm.email" placeholder="핸드폰 번호나 이메일 입력" />

                    <input name="password" v-model="signupForm.password" type="password" placeholder="비밀번호" />

                    <input name="name" v-model="signupForm.name" placeholder="이름" />

                    <button class="submitBtn">가입</button>
                </form>
    ...
    <footer>
        <ul class="flex flex-wrap justify-content-center">
            ...
            <li><a href="#">해시 태그</a></li>

        </ul>
        <p class="copyright">© 2025 Bstagram</p>
    </footer>
</template>
